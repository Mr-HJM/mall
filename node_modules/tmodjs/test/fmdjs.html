...
<head>
<meta charset="UTF-8">
<title>FmdJS - 调用模板演示</title>
<script type="text/javascript" src="http://style.c.aliimg.com/m/lofty/port/lofty.js"></script>
<script>
	lofty.config({
		resolve: function( id ) {
            var parts = id.split('/'),
            ...
            switch ( root ){
                case 'work':
                  id = 'tpl/build/' +  id.replace('work/','');
                break;
            }
              
            return id;
        },
		// baseUrl请根据自己的项目路径来设定
	   baseUrl:'http://127.0.0.1/tmodjs/test/'
	})
</script>
</head>
...
define(['work/index'], function (index) {
