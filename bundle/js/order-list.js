...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addressList = __webpack_require__(68);
	var deliveryList = __webpack_require__(69);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(12);
	module.exports=template('tpl/order-list/address-list',function($data,$filename
	/**/) {
	...
	$out+=' <div class="addresslist clearfix" data-id="';
	$out+=$escape($value.id);
	$out+='"> <div class="receiver-name fl">';
	$out+=$escape($value.receiver);
	$out+='</div> <div class="address-detail fl">';
	$out+=$escape($value.content);
	$out+='</div> <div class="phone-detail fl">';
	$out+=$escape($value.phone);
	$out+='</div> <input type="hidden" class="tel-phone" value="';
	$out+=$escape($value.telephone);
	$out+='"> <input type="hidden" class="email" value="';
	$out+=$escape($value.email);
	$out+='"> ';
	if($value.isDefault == '1'){
	$out+=' <div class="default-address fl">默认地址</div> <div class="set-address fr">编辑</div> ';
	}else{
	$out+=' <div class="delete-address fr">删除</div> <div class="set-address fr">编辑</div> <div class="set-default fr">设置默认地址</div> ';
	}
	$out+=' </div> ';
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(12);
	module.exports=template('tpl/order-list/delivery-list',function($data,$filename
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,$each=$utils.$each,$value=$data.$value,$index=$data.$index,$escape=$utils.$escape,$out='';$each($data,function($value,$index){
	$out+=' <div class="goods_list clearfix"> <div class="goods_list-left fl"> <div class="distribution">配送方式</div> <div class="express">快递运输</div> <div class="distribution-time">配送时间：<span>工作日、双休日与节假日均可送货</span></div> </div> <div class="goods_list-right fr"> <div class="goods_list_detail clearfix"> <img class="fl" src="';
	$out+=$escape($value.photourl);
	$out+='"> <div class="list_name fl">';
	$out+=$escape($value.name);
	$out+='</div> <div class="list_money fl">';
	$out+=$escape($value.money);
	$out+='</div> <div class="list_num fl">x';
	$out+=$escape($value.num);
	$out+='</div> <input type="hidden" name="productId" value="';
	$out+=$escape($value.goodsId);
	$out+='"> <input type="hidden" name="buynum" value="';
	$out+=$escape($value.num);
	$out+='"> </div> </div> </div> ';
	});
	return new String($out);
