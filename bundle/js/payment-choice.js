...
/***/ (function(module, exports, __webpack_require__) {
	...
	var payCode = __webpack_require__(73);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(12);
	module.exports=template('tpl/cart-base/wx-code',function($data,$filename
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,orderId=$data.orderId,$out='';$out+='<div class="wx-detail clearfix"> <img class="WePayLogo" src="../../bundle/img/WePayLogo.png"> <img id="wx-pay" src=\'http://211.143.45.225:8082/eshop/oapi/wx/pay?orderId=';
	$out+=$escape(orderId);
	$out+='\'> <img class="wx-help" src="../../bundle/img/wx-help.png"> </div> <div class="zfb-detail"> <img src="../../bundle/img/icon-zfb.png"> <span>↑ 点击进行支付</span> </div>';
	return new String($out);
	});
