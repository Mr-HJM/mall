...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addressList = __webpack_require__(61);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(12);
	module.exports=template('tpl/center-base/address-list',function($data,$filename
	/**/) {
	...
	$out+=' <div class="easebuy-m clearfix" data-id="';
	$out+=$escape($value.id);
	$out+='"> <div class="smt"> <div class="extra"> <a class="del-btn">删除</a> </div> </div> <div class="smc"> <div class="new-items clearfix"> <div class="item-lcol"> <div class="item clearfix"> <span class="label">收货人：</span> <div class="fl receiverVal">';
	$out+=$escape($value.receiver);
	$out+='</div> </div> <div class="item clearfix hide"> <span class="label">所在地区：</span> <div class="fl">';
	$out+=$escape($value.area);
	$out+='</div> </div> <div class="item clearfix"> <span class="label">地址：</span> <div class="fl contentVal">';
	$out+=$escape($value.content);
	$out+='</div> </div> <div class="item clearfix"> <span class="label">手机：</span> <div class="fl phoneVal">';
	$out+=$escape($value.phone);
	$out+='</div> </div> <div class="item clearfix"> <span class="label">固定电话：</span> <div class="fl telephoneVal">';
	$out+=$escape($value.telephone || '');
	$out+='</div> </div> <div class="item clearfix"> <span class="label">电子邮箱：</span> <div class="fl emailVal">';
	$out+=$escape($value.email);
	$out+='</div> </div> </div> <div class="item-rcol"> <div class="extra"> ';
	if($value.isDefault == '1'){
	$out+=' <a class="ml10 ftx-05 defalutAdd">默认地址</a> ';
	}else{
	$out+=' <a class="ml10 ftx-05 setDefault">设为默认</a> ';
	}
	$out+=' <a class="ml10 ftx-05 update">编辑</a> </div> </div> </div> </div> </div> ';
	});
	return new String($out);
	});
